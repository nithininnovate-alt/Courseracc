...
import { Globe, Users, BookOpen, CreditCard, GraduationCap, LogOut, Menu, Inbox, Plane, Mail, FileText, ClipboardList, BarChart3, Send, Handshake } from "lucide-react";
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { label: "Partners", href: "/admin/partners", icon: <Handshake className="w-4 h-4" /> },
